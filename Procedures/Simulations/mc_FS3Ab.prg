...
/* Experiment 3Ab: Unobserved single factor - non-Gaussian errors (Bias, RMSE, Size) */
/* Table 2 - main paper; Table S0 - appendix */
...
/*{rej,rej,powerp_fo,rej}=a_d(x1p,f,p_val,delta,p_test,a0,a1p,a1m,1); 
{rej,rej,rej,powerm_fo}=a_d(x1m,f,p_val,delta,p_test,a0,a1p,a1m,1);*/ 
