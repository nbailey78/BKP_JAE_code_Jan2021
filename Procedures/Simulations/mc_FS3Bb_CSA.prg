...
/* Experiment 3B: Two unobserved factors - non-Gaussian errors (Bias, RMSE - strongest factor CSA) */
/* Table 3- main paper */
...
x=ones(t,n)*c_v+f*gamm+eps;
 ...
 /* Estimation of alpha */
 /* CSA */
{a_hato,size_fo,rej,rej}=a_d(x,f,p_val,delta,p_test,a0,a1p,a1m,1);

/* Save */
if factor==1;
  /*sto_o1[o,m]=a_hato[1,1];  
